...
const EditStudent = () => {
  ...
  useEffect(() => {
    const object = JSON.parse(localStorage.getItem("students"))[params.id];
    setName(object.name);
    setgender(object.gender);
    setdob(object.dob);
    setMatric(object.matric);
    setdepartment(object.department);
    setfaculty(object.faculty);
    setCourses([...object.courses]);
    // console.log(object);
    seteditObj(object);
    // if (editObj.matric != "") {
    seteditMode(true);
  ...
  const handleSubmit = (e) => {
    ...
    storedStudents[params.id] = newStudent;
              ...
              <div key={index} className="d-flex courseForm">
                ...
                <div className="col-lg-2">
                  ...
                  <input
                    ...
                    value={course.score}
                    onChange={(e) =>
                      handleCourseChange(index, "score", e.target.value)
                    }
                  />
                </div>
                <div className="col-lg-2">
