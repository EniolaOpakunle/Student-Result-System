    ...
    <>
      <div className="container-fluid dashboard p-3">
        <div className="d-flex header">
          ...
          <div>
            <button
              className="button rounded px-3 py-1 mx-2"
              onClick={() => handleAdd()}
            >
              Add Student
            </button>
            <button className="button px-3 py-1 rounded" onClick={logout}>
              Log out
            </button>
          </div>
        </div>
        ...
        <div className="mt-5">
          <div className="d-flex">
            <h4>Students</h4>
            <input className="col-lg-3" type="text" placeholder="search" />
          </div>
          <div className="mt-3">
            <table>
              <thead>
